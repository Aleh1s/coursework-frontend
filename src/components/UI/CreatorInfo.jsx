...
const CreatorInfo = ({advertisementInfo}) => {
        ...
        <Container>
            <Row className={'mx-auto my-5 shadow-lg'}>
                <Col className={'d-flex justify-content-start align-items-center my-auto p-3 col-6'}>
                    ...
                    <p className={'mx-3 my-auto'} style={{fontSize: '17px'}}>Seller: {advertisementInfo.creatorFirstName} {advertisementInfo.creatorLastName}</p>
                </Col>
            ...
            <ModalPhone show={showModalPhone} phoneNumber={advertisementInfo.creatorPhone}
